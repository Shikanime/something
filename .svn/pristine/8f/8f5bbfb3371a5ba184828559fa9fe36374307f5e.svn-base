...
void describe_look() {
	character_should((uint8_t *) "look north", look_north);
	character_should((uint8_t *) "look east", look_east);
	character_should((uint8_t *) "look south", look_south);
	character_should((uint8_t *) "look west", look_west);
	character_should((uint8_t *) "look", look);
}
